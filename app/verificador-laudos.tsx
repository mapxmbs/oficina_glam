        ...
        <View className="flex-row items-center justify-between">
          ...
          <View className="flex-1 items-center">
            <View className="flex-row items-center">
              ...
              <Text style={[typography.screenTitle, { color: 'white', marginLeft: 8 }]}>Verificador</Text>
            </View>
            <Text style={[typography.screenSubtitle, { color: 'rgba(255,255,255,0.92)', marginTop: 4 }]}>Proteção Anti-Golpe</Text>
          </View>
